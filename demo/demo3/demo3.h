...
#ifndef DEMO3_INCLUDED
#define DEMO3_INCLUDED
...
#include "fcsplainbox.h"    /* the box-based focus conditions */
...
/* Extraction focus. */
extern SimpleBox3FocusOnTriangles focus;
...
/* Get and change reference value for area threshold */
extern float getAreaBound(void);
extern void changeAreaBound(float v);

/* ------------------------------------------------------------------------- */

#endif /* DEMO3_INCLUDED */
